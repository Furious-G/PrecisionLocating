...
<div class="hiring"><a href="mailto:precisionlocating.arizona@gmail.com" target="_blank"><img src="/wp-content/uploads/2023/07/hiring.png"></a></div>
        ...
        <div class="grid-x grid-padding-x grid-padding-y">
            <div class="cell large-7 wow fadeIn" data-wow-duration=".8s" data-wow-delay=".4s">
                ...
                <?php if( get_sub_field('display_call_now') ) : ?>
					<span class='call'>Call Now <?php the_field('phone_number', 'options'); ?> </span>
				<?php endif; ?>
            </div>
    ...
    <div class="grid-container">
        <div class="grid-x grid-padding-x grid-padding-y align-spaced">
            <div class="cell large-12 text-center">
                <span>Call Now <?php the_field('phone_number', 'options'); ?></span>
...
<section>
    <div class="grid-container text-center">
        ...
        <div class="grid-x grid-padding-x grid-padding-y grid-margin-x  align-center">
            ...
            <?php while ( $pet_query->have_posts() ) : $pet_query->the_post(); ?>
            	<?php $post_date = get_the_date( 'F j, Y' ); ?>
            <div class="cell large-4 petbox">
            	<div>
                <img src="<?php the_field( 'pet_image' ); ?>" />
                 <span><?php the_field( 'pet_name' ); ?><i><?php echo $post_date; ?></i></span>
                <div class="blurb text-left"><?php the_field( 'blurb' ); ?></div>
            	</div>
            </div>
                <?php endwhile; ?>
